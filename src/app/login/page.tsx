    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-[#EBF4FF] via-[#E8E0F5] to-[#F5E8F0] px-4 py-12">
      <div className="max-w-md w-full">
        ...
        <div className="lv-card p-7 mb-5">
          ...
          <button type="submit"
            className="w-full flex items-center justify-center gap-3 px-6 py-3.5 rounded-2xl bg-gradient-to-r from-[#6B93D8] via-[#D06AB8] to-[#F04E80] hover:from-[#5A82C8] hover:via-[#C05AA8] hover:to-[#E04070] text-white font-medium text-[15px] transition-all shadow-lg shadow-blue-200/50">
